...
class Surgery(dj.Manual):
    ...
    class Lesion(dj.Part):
        definition = """
        # The lesion method
        -> master
        lesion_id : int
        ---
        method         = null : varchar(256)  # suction, excitotoxic lesion        
        """
...
@schema
class Training(dj.Manual):
    definition = """
    -> Subject
    ---
    training_method: varchar(200)  # Manual or home cage    
    """
#    #contents =['Manual','Homecage semi-auto','Homecage auto']
