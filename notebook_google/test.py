...
#%% open
#sheet = client.open('Lesion metadata')
#sheetnames = list()
#worksheets = sheet.worksheets()
#for sheet1 in worksheets:
#    sheetnames.append(sheet1.title)
#idx_main = sheetnames.index('Rig')
#main_sheet = sheet.get_worksheet(idx_main)
...
#%%
a = fetch_water_restriction_metadata('NT4')
for df_wr_row in a.iterrows():
    b = df_wr_row[1].TaskType
    print(b)
